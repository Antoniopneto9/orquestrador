"""
functions.py — Business logic for the Monitor de Saude Mental agent page.
...
AGENT_NAME = "monitor"
AGENT_TITLE = "🫀 Monitor de Saúde Mental"
AGENT_CAPTION = "Acompanhamento de bem-estar, esgotamento e regulação emocional"


def carregar_ultimo_log() -> tuple:
    """Feature: load the most recent session log file for the monitor agent.
...
def listar_todas_sessoes() -> None:
    """Feature: expander listing all session log files for the monitor agent."""
