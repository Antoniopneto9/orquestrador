"""
functions.py — Business logic for the Tutor de Dados e IA agent page.
...
AGENT_NAME = "tutor"
AGENT_TITLE = "🤖 Tutor de Dados e IA"
AGENT_CAPTION = "Sessões de estudo em dados, IA e Claude Code"


def carregar_ultimo_log() -> tuple:
    """Feature: load the most recent session log file for the tutor agent.
...
def listar_todas_sessoes() -> None:
    """Feature: expander listing all session log files for the tutor agent."""
