"""
functions.py — Business logic for the Mentor de Rotina agent page.
...
# Point to streamlit/ so utils/ is importable
...
AGENT_NAME = "mentor"
AGENT_TITLE = "🧭 Mentor de Rotina"
AGENT_CAPTION = "Registros de sessão com o agente mentor — foco em rotina e disciplina diária"


def carregar_ultimo_log() -> tuple:
    """Feature: load the most recent session log file for the mentor agent.
...
def listar_todas_sessoes() -> None:
    """Feature: expander listing all session log files for the mentor agent."""
