"""
functions.py — Business logic for the Analista de Carreira agent page.
...
AGENT_NAME = "carreira"
AGENT_TITLE = "📈 Analista de Carreira"
AGENT_CAPTION = "Estratégias de visibilidade, posicionamento e promoção no agronegócio"


def carregar_ultimo_log() -> tuple:
    """Feature: load the most recent session log file for the carreira agent.
...
def listar_todas_sessoes() -> None:
    """Feature: expander listing all session log files for the carreira agent."""
